...
const navLinks = [
  { label: "VEHICLES", hasDropdown: false, isopen: false },
  ...
  return (
    <nav className="absolute top-0 left-0 w-full z-50 bg-gradient-to-b from-black/70 to-transparent text-white px-6 flex items-center justify-between">
      <div className="relative flex items-center">
        <a href="/" className="flex flex-col items-center group absolute top-8 left-8">
      ...
      <div className="hidden lg:flex items-center pl-[32rem] space-x-10 text-[0.850rem] font-medium tracking-widest pt-2">
      ...
      <div className="flex items-center space-x-4 text-xs font-semibold tracking-wider pt-2">
